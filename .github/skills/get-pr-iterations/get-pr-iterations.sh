#!/usr/bin/env bash
# Fetch pull request iterations (push updates) from Azure DevOps REST API
# Usage: ./get-pr-iterations.sh <organization> <project> <repositoryId> <pullRequestId>
...
curl -s --fail-with-body \
  ...
  "https://dev.azure.com/${ORG_ENC}/${PROJECT_ENC}/_apis/git/repositories/${REPO_ID_ENC}/pullRequests/${PR_ID}/iterations?api-version=7.2-preview"
